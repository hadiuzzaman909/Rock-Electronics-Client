        ...
        <div className='container mx-auto mt-5 Login shadow-lg p-3 mb-5 '>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <div className='d-flex justify-content-between'>
                    <Button className='toggle-btn mx-auto w-50 mb-2 ' variant="light" type="submit">
                        Login
                    </Button>
                </div>
            </Form>
            <div>
                <p>New to Rock Electronics? <Link className='text-primary text-decoration-none' to='/register'>Please Sign Up</Link></p>
