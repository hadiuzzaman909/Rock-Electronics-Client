                ...
                <Container className=''>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto navbarText side-section">
                            ...
                            <Nav>
                            {
                                user?<Nav.Link className='navbarText text-dark fw-bold blog' as={Link} to="/home">Home</Nav.Link>:<Nav.Link className='navbarText text-dark fw-bold blog' as={Link} to="/home">Home</Nav.Link>
                            }
                            </Nav>
                            <Nav>
                            {
                            ...
                            <Nav>
                            {
                                user?<Nav.Link className='navbarText text-dark fw-bold ' as={Link} to="/myItems">My Items</Nav.Link>:<p></p>
                            }
                            </Nav>
